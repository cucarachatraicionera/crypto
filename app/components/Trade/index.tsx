            ...
            <div className="grid lg:grid-cols-2 gap-x-5">
                ...
                <div>
                    ...
                    <div className="flex justify-between">
                        <Image src={'/images/Trade/mac.png'} alt="macOS-image" width={61} height={105} />
                        <div className="verticalLine"></div>
                        <Image src={'/images/Trade/appstore.png'} alt="appstore-image" width={80} height={105} />
                        <div className="verticalLine"></div>
                        <Image src={'/images/Trade/windows.png'} alt="windows-image" width={80} height={105} />
                        <div className="verticalLine"></div>
